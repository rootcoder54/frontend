...
export const FileUpload = ({
  ...
  const handleRetrait = (e: React.MouseEvent, index: number) => {
    e.stopPropagation(); 
    setFiles((prevFiles) => {
  ...
  return (
    <div className="w-full border rounded-lg" {...getRootProps()}>
      <motion.div
        whileHover="animate"
        onClick={handleClick}
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="relative z-20 font-sans font-normal text-neutral-400 dark:text-neutral-400 text-base mt-2">
            Glissez ou déposez vos images ici ou cliquez pour charger
          </p>
